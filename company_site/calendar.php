  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="#"><span class="glyphicon glyphicon-calendar"></span> Kalendarz</a></li>
		<li><a href="add.html"><span class="glyphicon glyphicon-plus"></span> Dodaj usluge</a></li>
      </ul>
    ...
    <div class="wrapper">
        ...
        <h3>tutaj będzie wyświetlany kalendarz</h3>
</body>
</html>